  ...
  BFHDatePicker.prototype = {
    ...
    initCalendar: function() {
      ...
      this.$element.html(
        ...
        '<a class="previous" href="#"><i class="fa fa-caret-left"></i></a>' +
        '<span></span>' +
  ...
  BFHNumber.prototype = {
    ...
    initInput: function() {
      ...
      if (this.options.buttons === true) {
        ...
        this.$element.parent().append('<span class="input-group-addon bfh-number-btn inc"><span class="fa fa-sort-up"></span></span>');
        this.$element.parent().append('<span class="input-group-addon bfh-number-btn dec"><span class="fa fa-sort-down"></span></span>');
      }
  ...
  * ========================= */
  ...
  BFHTimePicker.prototype = {
    ...
    initPopover: function() {
      ...
      if (this.options.icon !== '') {
        if (this.options.align === 'right') {
          iconRight = '<span class="input-group-addon"><i sclass="' + this.options.icon + '"></i></span>';
        } else {
          iconLeft = '<span class="input-group-addon"><i class="' + this.options.icon + '"></i></span>';
        }
        iconAddon = 'input-group';
      ...
      this.$element.html(
        ...
        '<tr>' +
        '<td class="hour">' +
        '<a class="next" href="#"><i class="fa fa-sort-up"></i></a><br>' +
        '<input type="text" readonly><br>' +
        '<a class="previous" href="#"><i class="fa fa-sort-down"></i></a>' +
        '</td>' +
