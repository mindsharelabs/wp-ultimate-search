jQuery(document).ready(function ($) {
    ...
    if(edd_ri_options.skipplugincheck != true) {
        ...
        $('a[data-edd-install]').each(function() {
            ...
            $.post(ajaxurl, data, function (res) {
                ...
                if(res) {
                    if(res == 'installed') {
                        $(downloadButton).prevAll(".eddri-status").text("Inactive").addClass('eddri-inactive');
                        $(downloadButton).text('Activate');
                    }
                    if(res == 'active') {
                        $(downloadButton).prevAll(".eddri-status").text("Active").addClass('eddri-active');
    ...
    $('body').on('click', 'a[data-edd-install]', function (e) {
        ...
        var downloadButton = $(this);
        var statusContainer = $(this).prevAll(".eddri-status");
    ...
    $.fn.validateLicense = function(downloadButton) {
        var statusContainer = $(downloadButton).prevAll(".eddri-status");
        var licenseInput;
